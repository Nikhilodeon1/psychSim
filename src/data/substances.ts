...
export const SUBSTANCES: Substance[] = [
  ...
  // ——— Stimulants
  {
    ...
    cls: 'Stimulant',
    action: 'Antagonist',
    target: 'Adenosine A1 receptors (and A2A)',
    systems: ['NE', 'DA', 'ACh'],
    otherSystems: ['Adenosine'],
    mechanism: 'Blocks adenosine A1 receptors, removing the brake adenosine puts on neural activity as waking hours accumulate.',
    ...
    sim: {
      ...
      clearance: {},
      release: ['NE', 'ACh'],
      receptors: [{ site: 'Adenosine A1', family: 'A1', mode: 'antagonist', direct: true }],
  ...
  },
  {
    ...
    sim: {
      peak: 2.5,
      halfLife: 10,
      nt: { DA: 1.8, NE: 1.4, '5HT': 0.15 },
      clearance: { DA: 0.7, NE: 0.6 },
      release: ['DA', 'NE'],
      reverses: ['DA', 'NE'],
      receptors: [D2_INDIRECT],
      axes: { arousal: 40, mood: 18, cognition: 0, load: 30 },
  ...
  // ——— Hallucinogens
  {
    ...
    tag: '5-HT2A agonism',
    teachingNote: 'Effects last roughly 8-12 hours, considerably longer than the blood half-life shown.',
    sim: {
      peak: 1,
      halfLife: 3.5,
      nt: { '5HT': 0.5, DA: 0.2 },
  ...
  },
  {
    ...
    teachingNote: 'Effects last roughly 4-6 hours, longer than the blood half-life shown.',
    sim: {
      peak: 1,
      halfLife: 2,
      nt: { '5HT': 0.45 },
  ...
  },
  {
    ...
    tag: '5-HT2A agonism',
    teachingNote: 'Effects last roughly 10-12 hours, longer than the blood half-life shown.',
    sim: {
      peak: 1.5,
      halfLife: 5,
      nt: { '5HT': 0.4 },
  ...
  // ——— Other (therapeutic teaching examples)
  {
    ...
    tag: 'SERT blockade',
    teachingNote: 'Serotonin rises within hours, but mood effects take two to six weeks — the therapeutic lag.',
    sim: {
      peak: 6,
      halfLife: 24,
      nt: { '5HT': 0.7 },
      ...
      slowsClearanceOf: ['mdma', 'antipsychotics'],
    },
  },
  {
    id: 'maoi',
    ...
    tag: 'MAO inhibition',
    teachingNote: 'Like SSRIs, monoamines rise within hours but mood effects take weeks.',
    sim: {
      peak: 2,
      halfLife: 8,
  ...
  },
  {
    ...
    tag: 'D2 blockade',
    teachingNote: 'Strong D2 blockade also slows movement (extrapyramidal effects) — the mirror image of L-DOPA.',
    sim: {
      peak: 2,
      halfLife: 20,
      nt: { DA: -0.45 },
      ...
      axes: { arousal: -10, mood: -4, cognition: -18, load: 8 },
